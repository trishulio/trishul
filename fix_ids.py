...
with open('modules/trishul-iaas-user/src/test/java/io/trishul/iaas/user/model/IaasUserTenantMembershipTest.java', 'r') as f:
    c = f.read()
c = re.sub(
...
with open('modules/trishul-iaas-user/src/test/java/io/trishul/iaas/user/model/IaasUserTenantMembershipTest.java', 'w') as f:
    f.write(c)
