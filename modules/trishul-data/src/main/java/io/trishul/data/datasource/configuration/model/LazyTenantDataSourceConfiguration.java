...
// TODO: Rename this to a datasource that automatically lazily fetches password, nothing to do with tenant
public class LazyTenantDataSourceConfiguration extends BaseModel implements DataSourceConfiguration {
    ...
    public String getPassword() {
        if (this.password == null) {
            try {
                ...
                throw new RuntimeException(String.format("Failed to load credentials for schema: '%s' because %s", getSchemaName(), e.getMessage()), e);
            }
        }
