package sh.trishul.iaas.idp.tenant.model.mapper;
...
class TenantIaasIdpResourcesMapperTest {
  ...
  @Test
  void testFromComponents_ReturnsResources() {
    ...
    List<TenantIaasIdpResources> expected
        = List.of(new TenantIaasIdpResources(new IaasIdpTenant("T1")),
