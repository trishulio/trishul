...
public class IaasIdpTenantServiceTest {
    ...
    private UpdateService<String, IaasIdpTenant, BaseIaasIdpTenant, UpdateIaasIdpTenant> mUpdateService;
    ...
    public void testGet_ReturnsAttachmentFromRepo() {
        doAnswer(inv -> List.of(new IaasIdpTenant((String) inv.getArgument(0, Set.class).iterator().next()))).when(mIaasRepo).get(anySet());
    ...
    public void testGetByAccessorIds_ReturnsAttachmentFromRepo() {
        ...
        IaasIdpTenantAccessor accessor = new IaasIdpTenantAccessor() {
            @Override
    ...
    public void testAdd_ReturnsAddedRepoEntities_AfterSavingAddEntitiesFromUpdateService() {
        ...
        List<BaseIaasIdpTenant> additions = List.of(
            new IaasIdpTenant("TENANT_1", new IaasRole("ROLE_1"), "DESCRIPTION_1", LocalDateTime.of(2000, 1, 1, 0, 0), LocalDateTime.of(2001, 1, 1, 0, 0)),
            new IaasIdpTenant("TENANT_2", new IaasRole("ROLE_2"), "DESCRIPTION_2", LocalDateTime.of(2000, 2, 1, 0, 0), LocalDateTime.of(2001, 2, 1, 0, 0))
        );

        List<IaasIdpTenant> attachments = service.add(additions);

        List<IaasIdpTenant> expected = List.of(
            new IaasIdpTenant("TENANT_1", new IaasRole("ROLE_1"), "DESCRIPTION_1", null, null),
            new IaasIdpTenant("TENANT_2", new IaasRole("ROLE_2"), "DESCRIPTION_2", null, null)
        );
    ...
    public void testPatch_ReturnsPatchRepoEntities_AfterSavingPatchEntitiesFromUpdateService() {
        ...
        doAnswer(inv -> {
            ...
            return List.of(
                new IaasIdpTenant(id1, new IaasRole("ROLE_1"), "DESCRIPTION_1", LocalDateTime.of(2000, 1, 1, 0, 0), LocalDateTime.of(2001, 1, 1, 0, 0)),
                new IaasIdpTenant(id2, new IaasRole("ROLE_2"), "DESCRIPTION_2", LocalDateTime.of(2000, 2, 1, 0, 0), LocalDateTime.of(2001, 2, 1, 0, 0))
            );
        }).when(mIaasRepo).get(anySet());

        List<UpdateIaasIdpTenant> updates = List.of(
            new IaasIdpTenant("TENANT_1", null, null, LocalDateTime.of(2000, 1, 1, 0, 0), LocalDateTime.of(2001, 1, 1, 0, 0)),
            new IaasIdpTenant("TENANT_2", new IaasRole("ROLE_2_UPDATED"), "DESCRIPTION_2_UPDATED", LocalDateTime.of(2000, 2, 1, 0, 0), LocalDateTime.of(2001, 2, 1, 0, 0))
        );

        List<IaasIdpTenant> attachments = service.patch(updates);

        List<IaasIdpTenant> expected = List.of(
            new IaasIdpTenant("TENANT_1", new IaasRole("ROLE_1"), "DESCRIPTION_1", null, LocalDateTime.of(2001, 1, 1, 0, 0)),
            new IaasIdpTenant("TENANT_2", new IaasRole("ROLE_2_UPDATED"), "DESCRIPTION_2_UPDATED",null, LocalDateTime.of(2001, 2, 1, 0, 0))
        );
