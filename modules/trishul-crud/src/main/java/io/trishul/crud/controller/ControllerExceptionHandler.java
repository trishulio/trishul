...
public class ControllerExceptionHandler {
    ...
    @ResponseStatus(value = HttpStatus.NOT_FOUND)
    public ErrorResponse emptyResultDataAccessException(
    ...
    @ResponseStatus(value = HttpStatus.CONFLICT)
    public ErrorResponse objectOptimisticLockingFailureException(
    ...
    @ResponseStatus(value = HttpStatus.NOT_FOUND)
    public ErrorResponse jpaObjectRetrievalFailureException(
            JpaObjectRetrievalFailureException e, HttpServletRequest request) {
        ErrorResponse response =
                new ErrorResponse(
                        LocalDateTime.now(),
                        HttpStatus.NOT_FOUND.value(),
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ErrorResponse illegalArgumentNotValidException(
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST)
    public ErrorResponse conversionFailedErrorResponse(
