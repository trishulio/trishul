...
public class IaasObjectStoreFileController extends BaseController {
    ...
    @Autowired
    public IaasObjectStoreFileController(
            IaasObjectStoreFileService objectStoreFileService, AttributeFilter filter) {
        this(
                new CrudControllerService<>(
                        filter,
                        IaasObjectStoreFileMapper.INSTANCE,
                        objectStoreFileService,
                        "IaasObjectStoreFile"),
                objectStoreFileService);
    }
    ...
    public List<IaasObjectStoreFileDto> getAll(@RequestParam(name = "files") Set<URI> files) {
        final List<IaasObjectStoreFile> objectStoreFiles =
                this.objectStoreFileService.getAll(files);
