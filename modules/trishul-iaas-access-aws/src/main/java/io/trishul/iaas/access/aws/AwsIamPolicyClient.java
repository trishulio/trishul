...
public class AwsIamPolicyClient implements IaasClient<String, IaasPolicy, BaseIaasPolicy, UpdateIaasPolicy> {
    ...
    public AwsIamPolicyClient(AmazonIdentityManagement awsIamClient, AwsArnMapper awsMapper, IaasEntityMapper<Policy, IaasPolicy> mapper) {
