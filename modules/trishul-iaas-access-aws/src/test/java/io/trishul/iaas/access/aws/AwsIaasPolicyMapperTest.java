...
public class AwsIaasPolicyMapperTest {
  ...
  public void testFromIaasEntity_ReturnsEntity_WhenArgIsNotNull() {
    ...
    IaasPolicy expected = new IaasPolicy("POLICY_NAME", null, "POLICY_DESCRIPTION", "POLICY_ARN",
        "POLICY_IAAS_ID", LocalDateTime.of(1901, 2, 1, 0, 0), LocalDateTime.of(1902, 3, 2, 0, 0));
