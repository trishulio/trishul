...
public class TenantContextAwsObjectStoreFileClientProviderTest {
    ...
    public void init() {
        ...
        provider =
                new TenantContextAwsObjectStoreFileClientProvider(
                        "REGION", mBucketNameProvider, mAuthFetcher, mFactory, 1000L);
    }
    ...
    public void testGetIaasRepository_ReturnsClientFromTenantContext() {
        ...
        doReturn(mS3)
                .when(mFactory)
                .s3Client("REGION", "ACCESS_KEY_ID", "ACCESS_SECRET_KEY", "SESSION_TOKEN");
        ...
        IaasRepository<URI, IaasObjectStoreFile, BaseIaasObjectStoreFile, UpdateIaasObjectStoreFile>
                client = provider.getIaasRepository();
