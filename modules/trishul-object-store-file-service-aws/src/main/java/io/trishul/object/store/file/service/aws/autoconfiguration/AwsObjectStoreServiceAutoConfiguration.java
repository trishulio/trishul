...
public class AwsObjectStoreServiceAutoConfiguration {
    ...
    public IaasRepositoryProvider<
        ...
        return new TenantContextAwsObjectStoreFileClientProvider(
                region, bucketNameProvider, authFetcher, awsFactory, getPresignUrlDuration);
    }
}
