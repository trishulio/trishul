...
class UserRoleControllerTest {
  ...
  void testGetAllUserRole_ReturnsDtosFromController() {
    ...
    doReturn(new PageDto<>(List.of(new UserRoleDto(1L)), 1, 1)).when(mCrudController)
        .getAll(new PageImpl<>(List.of(new UserRole(1L))), Set.of(""));

    PageDto<UserRoleDto> page = this.controller.getAllUserRoles(Set.of(1L), Set.of(2L),
        Set.of("name"), new TreeSet<>(List.of("userRolename")), true, 1, 100, Set.of(""));
