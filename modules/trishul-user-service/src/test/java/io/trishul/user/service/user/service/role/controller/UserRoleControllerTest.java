...
public class UserRoleControllerTest {
    ...
    public void testGetAllUserRole_ReturnsDtosFromController() {
        doReturn(new PageImpl<>(List.of(new UserRole(1L))))
                .when(mService)
                .getUserRoles(
                        Set.of(1L),
                        Set.of(2L),
                        ...
                        1,
                        100);
        doReturn(new PageDto<>(List.of(new UserRoleDto(1L)), 1, 1))
                .when(mCrudController)
                .getAll(new PageImpl<>(List.of(new UserRole(1L))), Set.of(""));

        PageDto<UserRoleDto> page =
                this.controller.getAllUserRoles(
                        Set.of(1L),
                        Set.of(2L),
                        Set.of("name"),
                        new TreeSet<>(List.of("userRolename")),
    ...
    public void testAddUserRoles_AddsToControllerAndReturnsListOfDtos() {
        doReturn(List.of(new UserRoleDto(1L)))
                .when(mCrudController)
                .add(List.of(new AddUserRoleDto()));
