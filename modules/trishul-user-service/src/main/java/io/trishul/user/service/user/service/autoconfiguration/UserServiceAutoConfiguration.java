...
public class UserServiceAutoConfiguration {
    ...
    public UserService userService(UtilityProvider utilProvider, LockService lockService, UserRepository userRepository, Refresher<User, UserAccessor<?>> userRefresher, TenantIaasUserService tenantIaasUserService) {
        final EntityMergerService<Long, User, BaseUser<?>, UpdateUser<?>> updateService = new CrudEntityMergerService<>(utilProvider, lockService, BaseUser.class, UpdateUser.class, User.class, Set.of());
    ...
    public UserRoleService userRoleService(UtilityProvider utilProvider, LockService lockService, UserRoleRepository userRoleRepository, Refresher<UserRole, UserRoleAccessor<?>> userRoleRefresher) {
        final EntityMergerService<Long, UserRole, BaseUserRole<?>, UpdateUserRole<?>> updateService = new CrudEntityMergerService<>(utilProvider, lockService, BaseUserRole.class, UpdateUserRole.class, UserRole.class, Set.of());
    ...
    @Bean
    public AccessorRefresher<Long, OwnedByAccessor<User>, User> ownedByAccessorRefresher(UserRepository repo) {
        return new AccessorRefresher<>(
            User.class,
    ...
    @Bean
    public UserRefresher userRefresher(AccessorRefresher<Long, UserAccessor<?>, User> userAccessorRefresher, AccessorRefresher<Long, AssignedToAccessor<?>, User> assignedToAccessorRefresher, AccessorRefresher<Long, OwnedByAccessor<User>, User> ownedByAccessorRefresher, Refresher<UserStatus, UserStatusAccessor<?>> statusRefresher, Refresher<UserSalutation, UserSalutationAccessor<?>> salutationRefresher, @Lazy Refresher<UserRoleBinding, UserRoleBindingAccessor<?>> roleBindingRefresher) {
