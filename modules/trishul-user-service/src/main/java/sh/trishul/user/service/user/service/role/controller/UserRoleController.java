package sh.trishul.user.service.user.service.role.controller;
...
import sh.trishul.user.role.model.AddUserRoleDto;
import sh.trishul.user.role.model.BaseUserRole;
import sh.trishul.user.role.model.UpdateUserRole;
import sh.trishul.user.role.model.UpdateUserRoleDto;
...
public class UserRoleController extends BaseController {
  ...
  @GetMapping(value = "/search", consumes = MediaType.ALL_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE)
  public sh.trishul.repo.jpa.repository.model.dto.PageDto<UserRoleDto> search(
    ...
    org.springframework.data.domain.Page<UserRole> entityPage
        = userRoleService.search(query, sort, orderAscending, page, size);
