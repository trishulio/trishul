package io.trishul.object.service.aws.client.provider;
...
import io.trishul.object.service.aws.client.AwsS3FileClient;
import io.trishul.object.service.aws.factory.AwsFactory;
...
import io.trishul.object.service.service.IaasObjectStoreNameProvider;
...
public class TenantContextAwsObjectStoreFileClientProvider implements IaasRepositoryProvider<URI, IaasObjectStoreFile, BaseIaasObjectStoreFile, UpdateIaasObjectStoreFile> {
    ...
    public TenantContextAwsObjectStoreFileClientProvider(String region, IaasObjectStoreNameProvider bucketNameProvider, TenantContextIaasAuthorizationFetcher authFetcher, AwsFactory awsFactory, Long getPresignUrlDuration) {
        ...
        // TODO: Instead of returning whole repository, implement a ClientProxy that refreshes clients
        this.cache = CacheBuilder.newBuilder()
                                 ...
                                 .build(new CacheLoader<GetAmazonS3ClientArgs, IaasRepository<URI, IaasObjectStoreFile, BaseIaasObjectStoreFile, UpdateIaasObjectStoreFile> >(){
                                    @Override
                                    public IaasRepository<URI, IaasObjectStoreFile, BaseIaasObjectStoreFile, UpdateIaasObjectStoreFile>  load(@Nonnull GetAmazonS3ClientArgs args) throws Exception {
