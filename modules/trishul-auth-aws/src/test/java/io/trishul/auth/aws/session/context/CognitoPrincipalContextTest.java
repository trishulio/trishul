...
public class CognitoPrincipalContextTest {
    ...
    public void init() {
        ...
        doReturn("SCOPE_1 SCOPE_2")
                .when(mJwt)
                .getClaimAsString(CognitoPrincipalContext.CLAIM_SCOPE);
    ...
    public void testConstructor_ThrowsError_WhenMultipleGroupValuesArePresent() {
        ...
        assertThrows(
                ...
                () -> new CognitoPrincipalContext(mJwt),
                "ach user should only belong to a single cognito group. Instead found 2");
    }
