...
public class AwsCognitoIdentitySdkWrapperTest {
  ...
  public void testGetIdentityPools_ReturnsPoolsWithAllItems_WhenMaxItemValueIsMore() {
    List<IdentityPoolShortDescription> page1 = List.of(
        ...
        new IdentityPoolShortDescription().withIdentityPoolId("POOL_ID_2")
            .withIdentityPoolName("POOL_NAME_2"));
    List<IdentityPoolShortDescription> page2 = List.of(
        new IdentityPoolShortDescription().withIdentityPoolId("POOL_ID_3")
            .withIdentityPoolName("POOL_NAME_3"),
        new IdentityPoolShortDescription().withIdentityPoolId("POOL_ID_4")
            .withIdentityPoolName("POOL_NAME_4"));
    List<IdentityPoolShortDescription> page3 = List.of(
        new IdentityPoolShortDescription().withIdentityPoolId("POOL_ID_5")
            .withIdentityPoolName("POOL_NAME_5"),
        new IdentityPoolShortDescription().withIdentityPoolId("POOL_ID_6")
            .withIdentityPoolName("POOL_NAME_6"));

    doReturn(new ListIdentityPoolsResult().withIdentityPools(page1).withNextToken("NEXT_1"))
        .when(mAws)
        .listIdentityPools(new ListIdentityPoolsRequest().withNextToken(null).withMaxResults(10));
    doReturn(new ListIdentityPoolsResult().withIdentityPools(page2).withNextToken("NEXT_2"))
        .when(mAws).listIdentityPools(
            new ListIdentityPoolsRequest().withNextToken("NEXT_1").withMaxResults(10));
    doReturn(new ListIdentityPoolsResult().withIdentityPools(page3).withNextToken(null)).when(mAws)
        .listIdentityPools(
            new ListIdentityPoolsRequest().withNextToken("NEXT_2").withMaxResults(10));
  ...
  public void testGetIdentityPools_ReturnsPoolsWithNItems_WhenMaxItemValueIsLess() {
    ...
    doReturn(new ListIdentityPoolsResult().withIdentityPools(page1).withNextToken("NEXT_1"))
        .when(mAws)
        .listIdentityPools(new ListIdentityPoolsRequest().withNextToken(null).withMaxResults(3));
    doReturn(new ListIdentityPoolsResult().withIdentityPools(page2).withNextToken("NEXT_2"))
        .when(mAws).listIdentityPools(
            new ListIdentityPoolsRequest().withNextToken("NEXT_1").withMaxResults(3));
  ...
  public void testGetCredentialsForIdentity_ReturnsCredentials() {
    ...
    doReturn(new GetCredentialsForIdentityResult().withCredentials(creds)).when(mAws)
        .getCredentialsForIdentity(new GetCredentialsForIdentityRequest()
            .withIdentityId("IDENTITY_ID").withLogins(Map.of("K", "V")));
