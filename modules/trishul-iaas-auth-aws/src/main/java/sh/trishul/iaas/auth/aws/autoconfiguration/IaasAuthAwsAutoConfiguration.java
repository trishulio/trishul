package sh.trishul.iaas.auth.aws.autoconfiguration;
...
import sh.trishul.iaas.auth.aws.client.AwsCognitoIdentityClient;
import sh.trishul.iaas.auth.aws.client.AwsCognitoIdentitySdkWrapper;
import sh.trishul.iaas.auth.aws.client.AwsIdentityCredentialsMapper;
import sh.trishul.iaas.auth.aws.client.AwsResourceCredentialsFetcher;
import sh.trishul.iaas.auth.aws.client.CachedAwsCognitoIdentityClient;
import sh.trishul.iaas.auth.aws.factory.IaasAuthAwsFactory;
