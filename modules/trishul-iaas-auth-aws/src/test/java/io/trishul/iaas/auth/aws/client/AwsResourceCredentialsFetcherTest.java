...
public class AwsResourceCredentialsFetcherTest {
    ...
    public void init() {
        ...
        fetcher =
                new AwsResourceCredentialsFetcher(
                        mIdentityClient, AwsIdentityCredentialsMapper.INSTANCE, "USER_POOL");
    }
    ...
    public void testFetch_ReturnsCredentials() {
        doReturn(List.of(new IdentityPoolShortDescription().withIdentityPoolId("POOL_ID")))
                ...
                .getIdentityPools(1);
        doReturn("IDENTITY_ID")
                .when(mIdentityClient)
                .getIdentityId("POOL_ID", Map.of("USER_POOL", "TOKEN"));
