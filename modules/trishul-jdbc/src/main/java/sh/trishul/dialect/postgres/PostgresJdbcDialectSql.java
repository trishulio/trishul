...
public class PostgresJdbcDialectSql {
  ...
  public String grantPrivilege(String privilege, String resourceType, String resourceName,
      String username) {
  ...
  public String schemaExists() {
    return f("SELECT schema_name FROM information_schema.schemata WHERE schema_name = %s",
        placeholders(1));
  }
