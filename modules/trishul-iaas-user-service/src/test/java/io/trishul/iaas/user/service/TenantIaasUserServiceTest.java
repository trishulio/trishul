...
public class TenantIaasUserServiceTest {
    ...
    public void init() {
        ...
        service = new TenantIaasUserService(mUserService, mMembershipService, TenantIaasUserMapper.INSTANCE, mTenantIdProvider);
    }
    ...
    public void testPut_ReturnsMembershipsAfterSavingUsersAndCreatingMemberships() {
        ...
        List<IaasUserTenantMembership> expected = List.of(
            new IaasUserTenantMembership(new IaasUser("USERNAME_1", "example-1@localhost", "phone-number-1", null, null), "00000000-0000-0000-0000-000000000001"),
            new IaasUserTenantMembership(new IaasUser("USERNAME_2", "example-2@localhost", "phone-number-2", null, null), "00000000-0000-0000-0000-000000000001")
        );
