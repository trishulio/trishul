package sh.trishul.model.base.pojo.refresher.accessor;
...
public class CollectionAccessorRefresher<I, A, V extends Identified<I>> {
  ...
  public CollectionAccessorRefresher(Class<V> clazz, Function<A, Collection<V>> getter,
      BiConsumer<A, Collection<V>> setter, Function<Iterable<I>, List<V>> entityRetriever) {
    this.clazz = clazz;
    this.getter = getter;
    this.setter = setter;
