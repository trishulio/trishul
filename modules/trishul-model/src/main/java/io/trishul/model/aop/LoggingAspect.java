 ...
 * classes in the {@code io.trishul} package tree.
 *
 * <p>
...
public class LoggingAspect {
   ...
   * {@code io.trishul} package tree, as long as neither the class nor the method carry
   * {@link NoMethodLogging}.
   */
  @Pointcut("within(io.trishul..*)" + " && (within(*..*..*Service+) || within(*..*..*Controller+)"
