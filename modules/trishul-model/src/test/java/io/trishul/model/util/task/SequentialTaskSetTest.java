...
public class SequentialTaskSetTest {
    ...
    @Test
    public void
            testSubmitSupplier_ExecutesTheSupplierAndStoreResult_WhenSupplierRunsWithoutErrors() {
    ...
    @Test
    public void
            testSubmitRunnable_ExecutesTheRunnableAndStoreNullResult_WhenRunnableRunsWithoutErrors() {
        tasks.submit(() -> {});
    ...
    @Test
    public void
            testSubmitRunnable_ExecutesTheRunnablerAndStoreException_WhenRunnableThrowsException() {
        RuntimeException e = new RuntimeException();
        tasks.submit(
                new Runnable() {
                    @Override
