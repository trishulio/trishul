...
public class IaasPolicyServiceTest {
    ...
    public void testGet_ReturnsAttachmentFromRepo() {
        doAnswer(inv -> List.of(new IaasPolicy((String) inv.getArgument(0, Set.class).iterator().next()))).when(mIaasRepo).get(anySet());
    ...
    public void testGetByAccessorIds_ReturnsAttachmentFromRepo() {
        ...
        IaasPolicyAccessor accessor = new IaasPolicyAccessor() {
            @Override
    ...
    public void testAdd_ReturnsAddedRepoEntities_AfterSavingAddEntitiesFromUpdateService() {
        ...
        List<BaseIaasPolicy> additions = List.of(
            new IaasPolicy("POLICY_1", "DOCUMENT_1", "DESCRIPTION_1", "RES_NAME_1", "RES_ID_1", LocalDateTime.of(2000, 1, 1, 0, 0), LocalDateTime.of(2001, 1, 1, 0, 0)),
            new IaasPolicy("POLICY_2", "DOCUMENT_2", "DESCRIPTION_2", "RES_NAME_2", "RES_ID_2", LocalDateTime.of(2000, 2, 1, 0, 0), LocalDateTime.of(2001, 2, 1, 0, 0))
        );

        List<IaasPolicy> attachments = service.add(additions);

        List<IaasPolicy> expected = List.of(
            new IaasPolicy("POLICY_1", "DOCUMENT_1", "DESCRIPTION_1", "RES_NAME_1", "RES_ID_1", null, null),
            new IaasPolicy("POLICY_2", "DOCUMENT_2", "DESCRIPTION_2", "RES_NAME_2", "RES_ID_2", null, null)
        );
    ...
    public void testPatch_ReturnsPatchRepoEntities_AfterSavingPatchEntitiesFromUpdateService() {
        ...
        doAnswer(inv -> {
            ...
            return List.of(
                new IaasPolicy(id1, "DOCUMENT_1", "DESCRIPTION_1", "RES_NAME_1", "RES_ID_1", LocalDateTime.of(2000, 1, 1, 0, 0), LocalDateTime.of(2001, 1, 1, 0, 0)),
                new IaasPolicy(id2, "DOCUMENT_2", "DESCRIPTION_2", "RES_NAME_2", "RES_ID_2", LocalDateTime.of(2000, 2, 1, 0, 0), LocalDateTime.of(2001, 2, 1, 0, 0))
            );
        }).when(mIaasRepo).get(anySet());

        List<UpdateIaasPolicy> updates = List.of(
            new IaasPolicy("POLICY_1", null, null, "RES_NAME_1_UPDATED", "RES_ID_1_UPDATED", LocalDateTime.of(2000, 1, 1, 0, 0), LocalDateTime.of(2001, 1, 1, 0, 0)),
            new IaasPolicy("POLICY_2", "DOCUMENT_2_UPDATED", "DESCRIPTION_2_UPDATED", null, null, LocalDateTime.of(2000, 2, 1, 0, 0), LocalDateTime.of(2001, 2, 1, 0, 0))
        );

        List<IaasPolicy> attachments = service.patch(updates);

        List<IaasPolicy> expected = List.of(
            new IaasPolicy("POLICY_1", "DOCUMENT_1", "DESCRIPTION_1", "RES_NAME_1_UPDATED", "RES_ID_1_UPDATED", null, LocalDateTime.of(2001, 1, 1, 0, 0)),
            new IaasPolicy("POLICY_2", "DOCUMENT_2_UPDATED", "DESCRIPTION_2_UPDATED","RES_NAME_2", "RES_ID_2", null, LocalDateTime.of(2001, 2, 1, 0, 0))
        );
