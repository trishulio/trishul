package sh.trishul.repo.jpa.query.clause.where.builder;
...
import sh.trishul.repo.jpa.query.spec.criteria.ILikeSpec;
import sh.trishul.repo.jpa.query.spec.criteria.InSpec;
import sh.trishul.repo.jpa.query.spec.criteria.IsNullSpec;
import sh.trishul.repo.jpa.query.spec.criteria.IsSpec;
