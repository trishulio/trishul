...
import sh.trishul.ai.chat.model.AiChatModelConfigMapper;
...
public class AiChatModelConfigController extends BaseController {
  ...
  @GetMapping(value = "/search", consumes = MediaType.ALL_VALUE,
      produces = MediaType.APPLICATION_JSON_VALUE)
  public sh.trishul.repo.jpa.repository.model.dto.PageDto<AiChatModelConfigDto> search(
    ...
    org.springframework.data.domain.Page<AiChatModelConfig> entityPage
