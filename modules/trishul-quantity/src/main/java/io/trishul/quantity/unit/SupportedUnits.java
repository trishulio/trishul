...
public class SupportedUnits {
    ...
    public static final Unit<Mass> MILLIGRAM =
            new TransformedUnit<>(
                    ...
                    SupportedUnits.KILOGRAM,
                    SupportedUnits.KILOGRAM.getSystemUnit(),
                    RationalConverter.of(1, 1000000));
