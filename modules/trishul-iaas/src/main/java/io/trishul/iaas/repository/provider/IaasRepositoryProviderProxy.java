...
public class IaasRepositoryProviderProxy<ID, Entity extends Identified<ID>, BaseEntity, UpdateEntity>
  ...
  public IaasRepositoryProviderProxy(
      IaasRepositoryProvider<ID, Entity, BaseEntity, UpdateEntity> provider) {
