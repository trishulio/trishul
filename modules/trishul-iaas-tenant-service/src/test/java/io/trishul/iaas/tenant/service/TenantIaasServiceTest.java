...
public class TenantIaasServiceTest {
    ...
    public void init() {
        ...
        this.service =
                new TenantIaasService(
                        mAuthService, mIdpService, mVfsService, TenantIaasIdpTenantMapper.INSTANCE);
    }
    ...
    public void testGet_GetsAndReturnsListTenantIaasResourcesFromIndividualResources() {
        ...
        List<TenantIaasAuthResources> authResources =
                List.of(
                        new TenantIaasAuthResources(new IaasRole("T1_ROLE")),
        ...
        List<TenantIaasVfsResources> vfsResources =
                List.of(
                        new TenantIaasVfsResources(
                                new IaasObjectStore("T1_OBJECT_STORE"),
                                new IaasPolicy("T1_POLICY")),
                        new TenantIaasVfsResources(
                                new IaasObjectStore("T2_OBJECT_STORE"),
        ...
        List<TenantIaasResources> expected =
                List.of(
    ...
    public void testDelete_DeletesAndReturnsCombinedDeleteResult() {
        ...
        TenantIaasDeleteResult expected =
                new TenantIaasDeleteResult(
                        new TenantIaasAuthDeleteResult(3),
                        new TenantIaasIdpDeleteResult(4),
                        new TenantIaasVfsDeleteResult(5, 6));
