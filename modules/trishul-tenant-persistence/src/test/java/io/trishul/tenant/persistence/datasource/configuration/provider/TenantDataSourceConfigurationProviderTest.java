...
public class TenantDataSourceConfigurationProviderTest {
    ...
    public void init() throws URISyntaxException {
        mAdminTenant =
                new AdminTenant(UUID.fromString("00000000-0000-0000-0000-000000000000"), "ADMIN");
        mGlobalDsConfig =
                new ImmutableGlobalDataSourceConfiguration(
                        new URI("jdbc://url/"), "dbName", "MIGRATION_PATH", "SCHEMA_", 10, false);
        mAdminConfig =
        ...
        dsProvider =
                new TenantDataSourceConfigurationProvider(
                        mAdminConfig, mAdminTenant, mGlobalDsConfig, mConfigMgr, mSecretsMgr);
    }

    @Test
    public void testGetConfiguration_ReturnsAdminConfig_WhenIdMatchesAdminId() {
        DataSourceConfiguration config =
                dsProvider.getConfiguration(
