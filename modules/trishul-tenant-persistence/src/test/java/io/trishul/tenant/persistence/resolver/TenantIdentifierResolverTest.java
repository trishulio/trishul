...
class TenantIdentifierResolverTest {
  ...
  @Test
  void testResolveCurrentTenantIdentifier_ReturnsTenantIdFromTenantIdProvider() {
    doReturn(UUID.fromString("00000000-0000-0000-0000-000000000000")).when(mTenantIdProvider)
        .getTenantId();
  ...
  @Test
  void testValidateExistingCurrentSessions_returnsTrue() {
